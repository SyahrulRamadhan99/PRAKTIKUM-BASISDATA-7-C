...
-- Membuang struktur basisdata untuk praktikum_presensi
CREATE DATABASE IF NOT EXISTS `praktikum_presensi` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `praktikum_presensi`;

-- membuang struktur untuk table praktikum_presensi.bagian
...
-- Membuang data untuk tabel praktikum_presensi.bagian: ~3 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.bagian_karyawan
...
-- Membuang data untuk tabel praktikum_presensi.bagian_karyawan: ~12 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.jabatan
...
-- Membuang data untuk tabel praktikum_presensi.jabatan: ~5 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.jabatan_karyawan
...
-- Membuang data untuk tabel praktikum_presensi_penggajian.jabatan_karyawan: ~17 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.karyawan
...
-- Membuang data untuk tabel praktikum_presensi.karyawan: ~8 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.lokasi
...
-- Membuang data untuk tabel praktikum_presensi.lokasi: ~3 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.penggajian
...
-- Membuang data untuk tabel praktikum_presensi.penggajian: ~18 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.pengguna
...
-- Membuang data untuk tabel praktikum_presensi.pengguna: ~8 rows (lebih kurang)
...
-- membuang struktur untuk table praktikum_presensi.presensi
...
-- Membuang data untuk tabel praktikum_presensi.presensi: ~552 rows (lebih kurang)
